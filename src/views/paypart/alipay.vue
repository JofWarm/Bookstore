<template>
  <div id="alipay-page">
    ...
    <el-button type="primary" @click="back" class="cancel-button">取消支付</el-button>
  </div>
</template>
<script>
export default {
  data() {
    return {
      qrCodeUrl: require('./img/ali.jpg') // 确保路径正确
    };
  },
  methods: {
    back() {
...
.qr-code {
  ...
  height: auto; /* 让高度自动，保持纵横比 */
  max-width: 100%; /* 确保在小屏幕上显示正常 */
}
