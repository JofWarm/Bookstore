  ...
  <div class="container">
    ...
    <div class="pay-type-content">
      <div class="pay-type-item">
        ...
        <el-image :src="require('@/assets/wechatpay.png')" style="height: 80px;width: 80px" ></el-image>
        <!-- <span>微信支付</span> -->
      </div>
      <div class="pay-type-item">
        <el-radio v-model="type" label="支付宝支付"></el-radio>
        <el-image :src="require('@/assets/alipay.png')" style="height: 80px;width: 80px"></el-image>
        <!-- <span>支付宝支付</span> -->
      </div>
